...
# TODO: Provide your GCS Bucket name.
BUCKET_NAME = 'gcp-bkt101'
...
# Path to the data inside the public bucket
blob = bucket.blob('ai-platform/sklearn/census_data/adult.test')
# Download the data
blob.download_to_filename('adult.test')
...
score = classifier.score(preprocess.transform(test_features), test_labels)  
# Print the Score
